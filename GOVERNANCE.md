...
`cloud-itonami-iso3166-moz` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Mozambican-licensed counsel or a registered agent for whatever licensed
representation the law of Mozambique requires for public-procurement
filings.
